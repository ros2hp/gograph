...
type NV struct {
	...
	DT    string    // ros2hp/gograph datatype: N,S,Bl,B, LN,LS,LBL,LB, Nd, SN,SS,SBl, SB
	C     string    // RDF predicate (equiv to ros2hp/gograph type attribute name) short name
	Value interface{}
...
type Node struct {
	...
	TyName string    // node type name as referenced in ros2hp/gograph Type system. getType() returns GoGraph type based on type name
	Lines  []Line
