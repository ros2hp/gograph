...
import (
	...
	mparam "github.com/ros2hp/gograph/dygparam"
	"github.com/ros2hp/gograph/syslog/internal/wrt"
	"github.com/ros2hp/gograph/syslog/param"
)
...
// NewBaseErrFile creates a log file based on name ros2hp/gograph.[a..z].log. Current  a..z value stored in log.id file in directory LOGDIR (envion variable)
